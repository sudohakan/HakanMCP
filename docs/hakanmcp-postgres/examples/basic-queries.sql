...
-- from sudohakan/ruvector (77+ SQL functions)
--
...
-- Set search path
SET search_path TO hakanmcp, ruvector, public;
...
FROM hakanmcp.embeddings a
CROSS JOIN hakanmcp.embeddings b
WHERE a.id < b.id
...
INSERT INTO hakanmcp.patterns (name, description, embedding, pattern_type, confidence)
VALUES (
    'api-error-handling',
...
INSERT INTO hakanmcp.agents (agent_id, agent_type, state, memory_embedding)
VALUES (
    'coder-v3-001',
    'coder',
...
SELECT ruvector.learn_optimize('hakanmcp.embeddings', 'embedding');
...
DELETE FROM hakanmcp.embeddings
WHERE created_at < NOW() - INTERVAL '30 days';

-- Vacuum and analyze for optimal performance
VACUUM ANALYZE hakanmcp.embeddings;
VACUUM ANALYZE hakanmcp.patterns;
VACUUM ANALYZE hakanmcp.agents;

-- Reindex HNSW (if needed after many updates)
REINDEX INDEX CONCURRENTLY hakanmcp.idx_embeddings_hnsw;
