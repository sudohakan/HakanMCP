# HakanMCP Deep Regression Test Suite

Comprehensive Docker-based test suite for verifying all HakanMCP capabilities.
...
| `HAKANMCP_MODE` | `test` | Operating mode |
| `HAKANMCP_MEMORY_PATH` | `/app/data` | Memory storage path |
| `HAKANMCP_LOG_LEVEL` | `debug` | Log verbosity |
| `HAKANMCP_MAX_AGENTS` | `15` | Max concurrent agents |
...
|---------|-------|-----------|
| @hakanmcp/hooks | 112 | 100% |
| @hakanmcp/plugins | 142 | 100% |
| @hakanmcp/security | 47 | 100% |
| @hakanmcp/swarm | 89 | 100% |
| @hakanmcp/cli | 34 | 100% |
