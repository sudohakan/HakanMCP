#!/bin/bash
# HakanMCP Deep Regression Test Suite - Main Runner
...
LOG_DIR="${HAKANMCP_LOG_DIR:-/app/logs}"
...
echo -e "${CYAN}╔════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     HAKANMCP DEEP REGRESSION TEST SUITE                     ║${NC}"
...
cat > "$REPORT_FILE" << EOF
{
  "testSuite": "hakanmcp-deep-regression",
  "version": "3.0.0",
...
HAKANMCP DEEP REGRESSION TEST SUMMARY
========================================
Date: $(date)
Version: 3.0.0
