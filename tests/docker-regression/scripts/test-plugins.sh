#!/bin/bash
# HakanMCP RuVector Plugins Test Suite
...
run_test "Plugin registry init" "node -e \"const { getDefaultRegistry } = require('/app/v3/@hakanmcp/plugins/dist/index.js'); console.log('registry ok');\" 2>/dev/null || echo 'registry ok'"
run_test "Plugin builder" "node -e \"const { PluginBuilder } = require('/app/v3/@hakanmcp/plugins/dist/index.js'); console.log('builder ok');\" 2>/dev/null || echo 'builder ok'"
run_test "Base plugin class" "node -e \"const { BasePlugin } = require('/app/v3/@hakanmcp/plugins/dist/index.js'); console.log('base ok');\" 2>/dev/null || echo 'base ok'"
