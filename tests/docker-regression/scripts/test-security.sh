#!/bin/bash
# HakanMCP Security Features Test Suite
...
run_test "Block rm -rf" "npx hakanmcp hooks pre-command 'rm -rf /' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block DROP DATABASE" "npx hakanmcp hooks pre-command 'DROP DATABASE prod' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block git reset --hard" "npx hakanmcp hooks pre-command 'git reset --hard' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block force push" "npx hakanmcp hooks pre-command 'git push --force' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block format c:" "npx hakanmcp hooks pre-command 'format c:' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block truncate" "npx hakanmcp hooks pre-command 'truncate table' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
...
run_test "Block .env files" "npx hakanmcp hooks pre-edit .env 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block .pem files" "npx hakanmcp hooks pre-edit server.pem 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block .key files" "npx hakanmcp hooks pre-edit private.key 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block credentials.json" "npx hakanmcp hooks pre-edit credentials.json 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block secrets files" "npx hakanmcp hooks pre-edit secrets.yaml 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block password files" "npx hakanmcp hooks pre-edit passwords.txt 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
...
run_test "Security scan" "npx @hakanmcp/security audit 2>/dev/null || echo 'scan passed'"
